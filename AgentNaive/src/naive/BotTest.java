 ...
 * 
 */
public class BotTest extends Agent {

	protected final Logger log = Logger
			.getLogger(BotTest.class.getName());
	...
	private void handleAdNetworkDailyNotification(
		...
		{
			System.out.println("cost = "+notificationMessage.getCostMillis());

			/* add campaign to list of won campaigns */
			pendingCampaign.setBudget(notificationMessage.getCostMillis());///1000);
